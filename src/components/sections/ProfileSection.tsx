...
const contactInfo = {
  ...
  phone: '+91 8977568680',
  education: 'B.Tech CSE - Indian Institute of Information Technology Sricity',
  location: 'Hyderabad',
...
const contactHighlights = [
  ...
  { label: 'Availability', value: 'Open for internship and freelance roles' },
...
const socialLinks = [
  ...
  {
    name: 'LinkedIn',
    url: 'https://www.linkedin.com/in/karanam-raghuveer-3321ab374/',
    accent: '#60a5fa',
    icon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
  ...
  {
    name: 'LeetCode',
    url: 'https://leetcode.com/u/raghu2007/',
    accent: '#f59e0b',
    icon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
  ...
  {
    name: 'Codeforces',
    url: 'https://codeforces.com/profile/raghu_2007',
    accent: '#1F8ACB',
    icon: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
