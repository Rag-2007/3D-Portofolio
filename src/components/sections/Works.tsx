      ...
      >
        <div className="bg-tertiary group w-full rounded-2xl p-5">
          <div className="relative aspect-video w-full overflow-hidden rounded-2xl">
            {isUnderDevelopment && (
              <div className="absolute top-0 left-0 bg-gradient-to-r from-orange-500 to-amber-500 text-white font-bold text-[10px] tracking-wider px-3 py-1 rounded-br-lg shadow-lg z-30 pointer-events-none border-b border-r border-orange-400">
                🚧 UNDER DEVELOPMENT
              </div>
            )}
            <img
  ...
  return (
    ...
    >
      <Tilt
        ...
        className="w-full"
      >
        <div className="aiml-card group w-full h-full rounded-2xl p-5 flex flex-col relative overflow-hidden">
          ...
          <div className="relative aspect-video w-full overflow-hidden rounded-2xl">
            {/* Hackathon Winner Ribbon */}
            {isHackathonWinner && (
              <div className="absolute top-5 -left-12 w-48 -rotate-45 bg-gradient-to-r from-yellow-500 to-amber-600 text-white font-extrabold text-[11px] tracking-wider text-center py-1.5 shadow-2xl z-30 pointer-events-none border-b-2 border-yellow-300">
                🏆 WINNER
              </div>
            )}
            <img
          ...
          <div className="mt-5 relative z-10 flex-grow flex flex-col">
  ...
  return (
    <>
      ...
      <div className="flex w-full">
        ...
        >
          I am continuously learning and building across the software engineering spectrum — from{' '}
          <span className="text-white font-medium">actively developing scalable full-stack web applications</span>{' '}
          to{' '}
          <span className="text-white font-medium">engineering intelligent AI & Machine Learning systems</span>.
          Below are the projects I am currently working on that showcase my ongoing development journey, problem-solving mindset, and passion for engineering impactful solutions.
        </motion.p>
      </div>
      ...
      <div className="mt-20">
        <CategoryBadge
          ...
          subtitle="Actively developing robust & scalable application architectures"
          gradientFrom="#3b82f6"
          gradientTo="#06b6d4"
        />
