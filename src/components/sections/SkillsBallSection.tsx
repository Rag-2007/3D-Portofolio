...
const skillCategories = [
  {
    ...
    skills: ['HTML 5', 'CSS 3', 'JavaScript', 'TypeScript', 'React JS', 'Figma'],
  },
  {
    title: 'Backend',
    ...
    skills: ['Node JS', 'MongoDB', 'Express.js', 'Nest JS', 'Supabase', 'REST APIs'],
  },
  {
    title: 'AI / ML',
    ...
    skills: ['Python', 'TensorFlow', 'Scikit-Learn', 'Pandas', 'Numpy', 'Feature Engineering', 'HuggingFace', 'Deep Learning'],
  },
  {
    title: 'Tools & DevOps',
    ...
    skills: ['Git', 'GitHub', 'Docker', 'VS Code', 'Postman', 'Vercel', 'Jira'],
  },
];
